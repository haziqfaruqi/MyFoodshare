                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    <div class="space-y-1">
                                        <div class="flex items-center text-gray-900">
                                            ...
                                            {{ $verification->foodListing->restaurantProfile ? $verification->foodListing->restaurantProfile->restaurant_name : $verification->foodListing->creator->name ?? 'Unknown Donor' }}
                                        </div>
                                        <div class="flex items-center text-gray-900">
