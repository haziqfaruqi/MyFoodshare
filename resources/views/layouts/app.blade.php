...
<head>
    ...
    {{-- Firebase SDK - Disabled (Using Pusher for notifications instead)
    @auth
    <script type="module">
        // Firebase Cloud Messaging setup
        // To enable: Add Firebase credentials to .env file
        // FIREBASE_API_KEY, FIREBASE_PROJECT_ID, FIREBASE_SERVER_KEY, FIREBASE_VAPID_KEY
    </script>
    @endauth
    --}}
