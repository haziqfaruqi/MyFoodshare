...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Browse Available Food</h1>
            ...
            <div class="flex space-x-3">
                ...
                <a href="{{ route('recipient.matches.index') }}" class="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700 transition-colors text-sm font-medium flex items-center">
                    <svg class="h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-8">
            <form method="GET" class="flex flex-wrap gap-4 items-end">
                ...
                <button type="submit" class="bg-green-600 text-white px-6 py-2 rounded-md hover:bg-green-700 transition-colors font-medium">
                    Filter
                </button>
            </form>
        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                        ...
                        <div class="p-6">
                            <div class="flex items-start justify-between mb-4">
                                <div class="flex-1">
                                    <h3 class="text-lg font-semibold text-gray-900">{{ $listing->food_name }}</h3>
                            ...
                            <div class="flex space-x-2">
                                <a href="{{ route('recipient.browse.show', $listing) }}" 
                                   class="flex-1 bg-green-600 text-white py-2 px-4 rounded-md hover:bg-green-700 transition-colors text-sm font-medium text-center">
                                    View Details
                                </a>
                                @if($listing->matches->where('recipient_id', auth()->id())->count() > 0)
                                    <span class="flex-1 bg-gray-100 text-gray-500 py-2 px-4 rounded-md text-sm font-medium text-center">
                                        Interest Expressed
                                    </span>
                                @else
        ...
        @else
            <div class="bg-white rounded-lg shadow-lg p-12">
                <div class="text-center">
                    ...
                    <h3 class="mt-4 text-lg font-medium text-gray-900">No food listings found</h3>
